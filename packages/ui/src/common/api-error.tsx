  ...
  return (
    <div className={cn('col-span-full animate-fade-in', className)}>
      <div className="text-center space-y-4 py-8 px-4 max-w-md mx-auto">
        <div className="text-5xl mb-4 animate-bounce [animation-duration:2s] [animation-iteration-count:infinite]">
          {emoji}
        </div>

        <Heading
          as="h5"
          className="text-destructive animate-fade-in-up [animation-duration:0.5s]"
        >
          {title}
        </Heading>
        ...
        <Typography
          variant="body2"
          textColor="muted"
          className="mb-3 animate-fade-in [animation-duration:0.5s] [animation-delay:0.3s] [animation-fill-mode:both]"
        >
          {message}
        </Typography>
