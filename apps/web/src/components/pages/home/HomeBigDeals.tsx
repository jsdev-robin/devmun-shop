...
const HomeBigDeals = () => {
  ...
  const slidesToScroll = !sm ? 1 : !md ? 2 : !lg ? 2 : !xl ? 3 : 4;
              ...
              products.map((item, i) => (
                ...
                >
                  <div className="pb-4 h-full">
                    <Card className="p-0 relative overflow-hidden gap-0 flex flex-col h-full hover:shadow-4 group">
                      <Link
                      ...
                      <div className="p-2 flex flex-col flex-grow gap-1">
                        ...
                        {item.freeDelivery && (
                          <Typography variant="sm">Free delivery</Typography>
                        )}
                      </div>
                    </Card>
                  </div>
